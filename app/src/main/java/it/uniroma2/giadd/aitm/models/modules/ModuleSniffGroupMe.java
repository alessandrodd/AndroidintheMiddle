...
public class ModuleSniffGroupMe extends ModuleMitm implements Parcelable {

    private static final String TAG = ModuleSniffGroupMe.class.getName();
    ...
    protected ModuleSniffGroupMe(Parcel in) {
        super(in);
    }

    public static final Creator<ModuleSniffGroupMe> CREATOR = new Creator<ModuleSniffGroupMe>() {
        @Override
        public ModuleSniffGroupMe createFromParcel(Parcel source) {
            return new ModuleSniffGroupMe(source);
        }

        @Override
        public ModuleSniffGroupMe[] newArray(int size) {
            return new ModuleSniffGroupMe[size];
        }
    };
}
