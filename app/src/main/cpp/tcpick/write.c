    ...
    if (flags.writer.type == 1) {
        ...
        switch (flags.filenaming) {
            case 1:
                ...
                break;
            case 2:
                sprintf(base_name, "%s/tcpick_%06u_%s.both", dir_name, conn_ptr->num,
                        client_server);
                break;
        }
            ...
            case 2:
                switch (side) {
                    case CLIENT:
                        ...
                        sprintf(base_name, "%s/tcpick_%06u_%s.clnt", dir_name, conn_ptr->num,
                                client_server);
                        break;

                    case SERVER:

                        sprintf(base_name, "%s/tcpick_%06u_%s.serv", dir_name, conn_ptr->num,
                                client_server);
                        break;
                }
                break;
